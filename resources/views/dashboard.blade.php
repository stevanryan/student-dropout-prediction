...
<body>
    <div class="w-screen flex flex-col items-center justify-center h-screen bg-no-repeat bg-cover bg-center" style="background-image: url('{{ asset('iam_os-Gr7q7kqfnVU-unsplash.jpg') }}');">
        <div class="backdrop-blur-md bg-opacity-50 bg-black flex flex-col items-center justify-center w-full h-full">
            <h1 class="text-4xl text-white font-black text-center">Prediksi Dropout Mahasiswa</h1>
            <h3 class="text-xl text-white font-normal mb-8 mt-2 rounded-lg px-4 py-2">Cek <p class="text-blue-500 inline font-bold">prediksi dropout</p> mahasiswa sekarang!</h3>
            <div class="my-4 min-w-[360px]">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 811 304"
                    data-src="https://cdn.undraw.co/illustrations/graduation_u7uc.svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" role="img" artist="Katerina Limpitsouni"
                    source="https://undraw.co/">
                    <path id="b659e8b5-7e24-4e9b-ab8e-27842b197401-398" data-name="Path 438"
                    ...
                    <path id="bfce889d-851c-4599-b1ba-72c9c39792e6-399" data-name="Path 439"
                    ...
                    <path id="ac886c1d-ef9d-4a77-9e33-50e4cbfa9f0b-400" data-name="Path 442"
                        ...
                        transform="translate(-194.5 -298)" fill="#e6e6e6" />
                    <path id="f8957600-c762-4aa2-be12-aeea5f20d384-401" data-name="Path 443"
                        ...
                        transform="translate(-194.5 -298)" fill="#f2f2f2" />
                    <path id="f5e70a17-e793-41c1-a2dd-69237c970f4c-402" data-name="Path 438"
                        ...
                        transform="translate(-194.5 -298)" fill="#e6e6e6" />
                    <path id="b90780e1-a28a-4a8c-9c47-a4f5fb7f1aa8-403" data-name="Path 439"
                        ...
                        transform="translate(-194.5 -298)" fill="#f2f2f2" />
                    <path id="b244f669-d0df-4dab-b5dc-a763144460fd-404" data-name="Path 442"
                        ...
                        transform="translate(-194.5 -298)" fill="#e6e6e6" />
                    <path id="e7416fa3-7efb-4d63-8b89-2e15a53e835a-405" data-name="Path 443"
                    ...
                    <path
                        ...
                        transform="translate(-194.5 -298)" fill="#f1f1f1" style="isolation:isolate" />
                    <circle cx="326.65376" cy="50" r="6" fill="#f1f1f1" style="isolation:isolate" />
                    <circle cx="646.65376" cy="34" r="6" fill="#3b82f6" />
                    <circle cx="180.65376" cy="6" r="6" fill="#cbcbcb" />
                    <circle cx="157.57996" cy="241.62342" r="43.06733" fill="#2f2e41" />
                    <rect x="137.95433" y="275.42311" width="13.08374" height="23.44171" fill="#2f2e41" />
                    <rect x="164.12183" y="275.42311" width="13.08373" height="23.44171" fill="#2f2e41" />
                    <ellipse cx="148.85742" cy="299.1374" rx="10.90314" ry="4.08868" fill="#2f2e41" />
                    <ellipse cx="175.02496" cy="298.59223" rx="10.90314" ry="4.08868" fill="#2f2e41" />
                    <ellipse cx="393.18361" cy="515.50225" rx="23.89244" ry="7.50055"
                        transform="translate(-443.88763 131.25771) rotate(-45.0221)" fill="#2f2e41" />
                    <ellipse cx="300.47826" cy="518.50225" rx="7.50055" ry="23.89244"
                        transform="translate(-473.06891 66.11269) rotate(-44.9779)" fill="#2f2e41" />
                    ...
                    <path
                        ...
                        transform="translate(-194.5 -298)" fill="#3b82f6" />
                    <path
                    ...
                    <rect x="386.95433" y="275.42311" width="13.08374" height="23.44171" fill="#2f2e41" />
                    <rect x="413.12183" y="275.42311" width="13.08373" height="23.44171" fill="#2f2e41" />
                    <ellipse cx="397.85742" cy="299.1374" rx="10.90314" ry="4.08868" fill="#2f2e41" />
                    <ellipse cx="424.02496" cy="298.59223" rx="10.90314" ry="4.08868" fill="#2f2e41" />
                    <ellipse cx="642.18361" cy="515.50225" rx="23.89244" ry="7.50055"
                        transform="translate(-370.8893 307.39519) rotate(-45.0221)" fill="#2f2e41" />
                    <ellipse cx="556.47826" cy="556.50225" rx="23.89244" ry="7.50055"
                        transform="translate(-412.52142 398.19135) rotate(-55.22521)" fill="#2f2e41" />
                    ...
                    <rect x="893.07258" y="514.64598" width="13.08374" height="23.44171"
                        transform="translate(-336.98367 248.35991) rotate(-31.43113)" fill="#2f2e41" />
                    <rect x="870.74471" y="528.29163" width="13.08373" height="23.44171"
                        transform="translate(-347.37573 238.71877) rotate(-31.43113)" fill="#2f2e41" />
                    <ellipse cx="902.14742" cy="538.87471" rx="10.90314" ry="4.08868"
                        transform="translate(-343.13452 251.51609) rotate(-31.43113)" fill="#2f2e41" />
                    <ellipse cx="879.53522" cy="552.05521" rx="10.90314" ry="4.08868"
                        transform="translate(-353.32574 241.65844) rotate(-31.43113)" fill="#2f2e41" />
                    <ellipse cx="828.12393" cy="466.50225" rx="7.50055" ry="23.89244"
                        transform="translate(-281.91356 423.85434) rotate(-44.9779)" fill="#2f2e41" />
                    <ellipse cx="913.82928" cy="507.50225" rx="7.50055" ry="23.89244"
                        transform="translate(-320.74534 313.8443) rotate(-34.77479)" fill="#2f2e41" />
            ...
            <div class="mt-8 flex flex-col items-center justify-center">
                <h4 class="text-lg text-white font-medium">Cek sekarang juga!</h4>
                <a href={{ route('students.create') }}>
                    <button class="custom-hover-button px-4 py-2 mt-3 text-white rounded-md bg-blue-500">Mulai</button>
                </a>
            </div>
        </div>
    </div>
    <div class="absolute top-2 right-5">
        <a href={{ route('students.prediction.history') }}>
            <button class="custom-hover-button px-4 py-2 mt-3 text-white rounded-md bg-blue-500">History</button>
        </a>
    </div>
</body>
